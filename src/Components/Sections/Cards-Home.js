...
<div  className="ed-grid lg-grid-2">
  <div className="ed-grid lg-grid-2 s-grid-1 gap-2 l-block m-grid-2 row-gap">
              <div className="card">
              ...
              <div className="card small">
                ...
                <div className="card__data s-border s-radius-br s-radius-bl s-pxy-2">               
                  ...
                  <div className="s-main-center"><a className="button VerdeSaludClaro button--tiny" href="https://youtu.be/iw6QMKwx204">Video-Vacunas</a></div>
                </div>
              </div> 
