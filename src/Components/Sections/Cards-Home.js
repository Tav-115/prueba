const CardsHome = () => (
<div className="ed-grid lg-grid-4 gap-2 l-block m-grid-2 row-gap">
            <div className="card">
            ...
            <div className="card">
              ...
              <div className="card__data s-border s-radius-br s-radius-bl s-pxy-2">               
                ...
                <div classNameName="s-main-center"><a className="button VerdeSaludClaro button--tiny" href="Aprovados">Aprovados-Inmunizaciones</a></div>
              </div>
            </div>
            <div className="card">
